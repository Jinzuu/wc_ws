...
#define IRMP_FLEXIBLE_VERSION	// can be used for unsupported microcontrollers, e.g. ARM Controllers
...
#if defined( IRMP_FLEXIBLE_VERSION ) && defined( ANALYZE )
#warning Analyze is not implemented for the general usage case!
#endif
