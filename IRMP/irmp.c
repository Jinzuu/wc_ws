...
#ifdef IRMP_FLEXIBLE_VERSION
// Code for other microcontrollers ( ARM...)
#define PROGMEM
#define memcpy_P        memcpy
...
#define IRMP_KEY_REPETITION_LEN                 (uint16_t)(F_INTERRUPTS * 800.0e-3 + 0.5)           // autodetect key repetition within 1 sec
...
irmp_init (void)
{
#if !defined( PIC_CCS_COMPILER ) && !defined( IRMP_FLEXIBLE_VERSION )
