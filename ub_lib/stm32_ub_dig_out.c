...
DOUT_PIN_t DOUT_PIN[] = {
  ...
  {DOUT_PB9 ,GPIOB,GPIO_Pin_9 ,RCC_AHB1Periph_GPIOB,Bit_RESET},
  {DOUT_PB7 ,GPIOB,GPIO_Pin_7 ,RCC_AHB1Periph_GPIOB,Bit_RESET},
  {DOUT_PB5 ,GPIOB,GPIO_Pin_5 ,RCC_AHB1Periph_GPIOB,Bit_RESET},
  {DOUT_PB3 ,GPIOB,GPIO_Pin_3 ,RCC_AHB1Periph_GPIOB,Bit_RESET},
  {DOUT_PB4 ,GPIOB,GPIO_Pin_4 ,RCC_AHB1Periph_GPIOB,Bit_RESET},
  {DOUT_PA10 ,GPIOB,GPIO_Pin_10 ,RCC_AHB1Periph_GPIOA,Bit_RESET},
};
